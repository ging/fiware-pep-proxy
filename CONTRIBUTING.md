...
Thanks for checking out the Wilma Project. We're excited to hear and learn from you. We've put together the following
...
-   If you open a pull request, you must sign the
    [Individual Contributor License Agreement](https://github.com/ging/fiware-pep-proxy/blob/master/wilma-individual-cla.pdf) by
...
If you'd like to contribute, start by searching through the [issues](https://github.com/ging/fiware-pep-proxy/issues) and
[pull requests](https://github.com/ging/fiware-pep-proxy/pulls) to see whether someone else has raised a similar idea or
question.
...
[Issues](https://github.com/ging/fiware-pep-proxy/issues) and [Pull Requests](https://github.com/ging/fiware-pep-proxy/pulls)
